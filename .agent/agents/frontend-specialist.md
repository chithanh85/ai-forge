...
model: inherit
skills: clean-code, nextjs-react-expert, web-design-guidelines, tailwind-patterns, frontend-design, ui-ux-pro-max, design-tokens, open-design-bridge, lint-and-validate
---
